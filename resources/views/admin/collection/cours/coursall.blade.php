            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="contentmore">
                        <button class="edit" onclick="openEditCours('{{ $cours->id }}','{{$cours->intitule}}')">Modifier</button>
                        <button class="delete"><a href="{{ route('admin.DeleteCours',['id'=>$cours->id]) }}">Supprimer</a></button>
                    </div>
                </div>
            </div>
        @endforeach
